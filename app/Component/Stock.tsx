            ...
            <table className="table-auto border-collapse w-full text-left bg-[#F7F7F7] rounded-md">
              <thead className="bg-[#E5ECEF] text-black">
                <tr>
                  ...
                  <th className="border-b px-4 py-2">Quantity In Stock</th>
                  <th className="border-b px-4 py-2">Quantity Sold</th>
                  <th className="border-b px-4 py-2">Sub Total</th>
               </tr>
              </thead>
              <tbody>
                {table.map((row, rowIndex) => (
                  ...
                  >
                    <td className="border-b px-4 py-2 bg-[#EAF0F0]">{row.StockId}</td>
                    <td className="border-b px-4 py-2 bg-[#EAF0F0]">{row.QualityInStock}</td>
                    <td className="border-b px-4 py-2 bg-[#EAF0F0]">{row.QualitySold}</td>
                    <td className="border-b px-4 py-2 bg-[#EAF0F0]">{row.SubTotal}</td>
                  </tr>
                ))}
              </tbody>
            </table>
